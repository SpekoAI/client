import type { ConversationMessage, ConversationOverrides, MessageSource } from './types.js';
...
export type OutboundPacket = OverridesPacket | UserMessagePacket | ContextualUpdatePacket;
...
export type InboundPacket = TranscriptPacket | AgentMessagePacket | UserMessageEchoPacket;
...
export function packetToMessage(packet: InboundPacket): ConversationMessage | null {
